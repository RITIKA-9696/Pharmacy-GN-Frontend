...
document.addEventListener('DOMContentLoaded', () => {
  ...
  async function fetchProducts() {
    try {
      showLoadingState();
      // Fetch products by subcategory "Menstrual & Intimate Care"
      const encodedSubCategory = encodeURIComponent('Menstrual & Intimate Care');
      ...
      showErrorState('Failed to load Menstrual & Intimate Care products. Please try again later.');
  ...
  async function fetchProductsByCategory(category) {
    try {
      ...
      // Filter for Menstrual & Intimate Care products only from this category
      return transformedProducts.filter(product =>
        product.subCategory === 'Menstrual & Intimate Care' ||
        (product.productSubCategory && product.productSubCategory.toLowerCase().includes('menstrual & intimate care'))
      );
  ...
  function showLoadingState() {
    ...
    productGrid.innerHTML = `
      <div class="col-span-full flex justify-center items-center py-8">
        ...
        <span class="ml-3 text-gray-600">Loading Menstrual & Intimate Care products...</span>
      </div>
    `;
  }
  ...
  function displayProducts(list) {
    ...
    if (list.length === 0) {
      productGrid.innerHTML = `
        <div class="col-span-full text-center py-8">
          <p class="text-gray-500">No Menstrual & Intimate Care products found.</p>
